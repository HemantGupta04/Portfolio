                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-6 justify-center">
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="https://www.linkedin.com/in/hemant-gupta-b57bb4257/"
                                    target="_blank"
                                    className="text-muted-foreground text-left hover:text-primary transition-colors duration-300"
                                >
                                    Hemant Gupta
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a className="hover:text-primary" target="_blank" href="https://github.com/HemantGupta04">
                                <Github />
                            </a>
